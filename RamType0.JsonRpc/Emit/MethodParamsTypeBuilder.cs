...
namespace RamType0.JsonRpc
{
    public static partial class Emit
    {
        ...
        public interface IArrayStyleParamsDeserializer<T> : IParamsDeserializer<T>
            where T : struct, IMethodParams
        {
            //new T Deserialize(ref JsonReader reader, IJsonFormatterResolver formatterResolver);
            //T IParamsDeserializationProxy<T>.Deserialize(ref JsonReader reader, IJsonFormatterResolver formatterResolver) => Deserialize(ref reader, formatterResolver);
