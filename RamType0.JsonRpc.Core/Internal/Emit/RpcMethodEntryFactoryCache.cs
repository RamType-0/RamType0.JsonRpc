...
{
    using static RpcMethodEntryFactoryBuildingHelper;
    ...
    internal static class RpcInstanceMethodEntryFactoryCache<TDelegate>
        where TDelegate : notnull, Delegate
    {
        static RpcInstanceMethodEntryFactoryCache()
        {
    ...
    internal static class RpcStaticMethodEntryFactoryCache<TDelegate>
        where TDelegate : notnull, Delegate
    {
        static RpcStaticMethodEntryFactoryCache()
        {
            var tParams = RpcMethodEntryFactoryCache<TDelegate>.TParams;
            var tResult = RpcMethodEntryFactoryCache<TDelegate>.TResult;
            var valueTaskType = RpcMethodEntryFactoryCache<TDelegate>.ValueTaskType;
    ...
    internal static class RpcDelegateEntryFactoryCache<TDelegate>
        where TDelegate : notnull, Delegate
    {

        static RpcDelegateEntryFactoryCache()
        {
            var tParams = RpcMethodEntryFactoryCache<TDelegate>.TParams;
            var tResult = RpcMethodEntryFactoryCache<TDelegate>.TResult;
            var valueTaskType = RpcMethodEntryFactoryCache<TDelegate>.ValueTaskType;
    ...
    internal static class RpcMethodEntryFactoryBuildingHelper
    {
        ...
        {
            var builder = SharedResources.ModuleBuilder.DefineType(name, TypeAttributes.Public | TypeAttributes.Sealed | TypeAttributes.Class, typeof(ValueType));
